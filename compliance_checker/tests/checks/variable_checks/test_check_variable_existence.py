...
TEST_CHECK_VARIABLE_EXISTENCE = [
    ...
    ("variable_does_not_exist", "checks_test_ds", "novar", ["Variable 'novar' is missing"], (0, 1)),
]


@pytest.mark.parametrize(
    "test_id,ds_fixture,var_name,expected_msgs,expected_value",
    TEST_CHECK_VARIABLE_EXISTENCE,
    ids=[t[0] for t in TEST_CHECK_VARIABLE_EXISTENCE],
)
def test_check_variable_existence(request, test_id, ds_fixture, var_name, expected_msgs, expected_value):
