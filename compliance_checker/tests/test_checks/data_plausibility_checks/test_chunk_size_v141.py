...
from compliance_checker.checks.data_plausibility_checks import check_chunk_size_v141 as checker
...
class TestChunkSize(BaseTestCase):
    ...
    def test_chunk_size(self):
        ...
        output = checker.check_chunk_size(dataset, severity=BaseCheck.MEDIUM)
